...
// resolveStatusFilter 将外部 StatusFilter (0=全部, 1=待支付, 2=已完成, 3=超时取消, 4=失败)
...
// statusFilter: 0=全部(默认), 1=待支付, 2=已完成, 3=超时取消, 4=失败
...
// statusFilter: 0=全部, 1=待支付, 2=已完成, 3=超时取消, 4=失败;source: 0=全部, 1=App, 2=后台手动
