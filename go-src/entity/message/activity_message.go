...
type ActivityMessage struct {
	...
	IconId      string     `gorm:"size:255;default:'';comment:图标资源名(印尼语)" json:"iconId"`
	...
	BgId        string     `gorm:"size:255;default:'';comment:背景图资源名(印尼语)" json:"bgId"`
	...
	ContentId   string     `gorm:"type:text;comment:内容(印尼语)" json:"contentId"`
	...
	UrlId       string     `gorm:"size:512;default:'';comment:跳转链接(印尼语)" json:"urlId"`
