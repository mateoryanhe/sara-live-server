...
func (r *LiveRoomIncomeTotal) AddEffectiveLiveCount(v uint64) {
	addIncomeCount(TbLiveRoomIncomeTotal, LiveRoomIncomeEffectiveLiveCount, r.ID, &r.EffectiveLiveCount, v, &r.UpdatedAt)
}
