...
// LiveRevenueLog 直播间社交流水(礼物/付费弹幕/视频通话等钻石消费)
type LiveRevenueLog struct {
	...
	RevenueType  uint8     `gorm:"index:idx_lrl_biz_sender_type_status,priority:3;default:1;comment:流水类型(1礼物,2付费弹幕,7视频通话计费)" json:"revenueType"`
