...
func initDailyUserLogin() {
	syndb.RegLazy(TbDailyUserLogin, db.CreatedAtName)
	syndb.RegLazy(TbDailyUserLogin, DailyUserLoginUserId)
	syndb.RegLazy(TbDailyUserLogin, DailyUserLoginLoginDate)
