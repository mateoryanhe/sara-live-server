...
var codeTextMap = map[lang.Lang]map[XRCode]string{
	lang.LangEN: {
		...
		Ban:                             "Account banned",
		AccountCanceled:                 "Account has been canceled",
		...
		LiveRoomOffShelf:                "Live room is off shelf",
		...
		RechargeCfgProductIdExist:       "Recharge config product SKU already exists",
		...
		PrivateRoomBillingNonExist:      "1v1 call billing config does not exist",
		...
		ChannelPayNotConfigured:         "Channel payment is not configured",
		ChannelPayCreateFailed:          "Failed to create channel payment",
	...
	lang.LangZHCN: {
		...
		RechargeCfgProductIdExist:       "充值配置商品SKU已存在",
		InvalidParam:                    "参数无效",
		...
		PrivateRoomBillingNonExist:      "1v1通话计费配置不存在",
		...
		ChannelPayCreateFailed:          "创建渠道支付失败",
	...
	lang.LangZHTW: {
		...
		PrivateRoomBillingNonExist:      "1v1通話計費配置不存在",
		...
		ChannelPayNotConfigured:         "渠道支付未配置或未啟用",
		ChannelPayCreateFailed:          "建立渠道支付失敗",
