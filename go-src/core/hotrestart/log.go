...
const (
	...
	msgPhase2HTTPClose   = "热更新---第二阶段----收到http请求,close请求,URI=%s ip=%s"
...
// LogPhase2HTTPRequestClosed 第二阶段旧进程收到新 HTTP/WS 请求并关闭连接.
func LogPhase2HTTPRequestClosed(ctx context.Context, uri, ip string) {
