...
set BUILD_CMD=build:review
set ZIP_FILE=upload_package_review.zip

echo ========================================
echo CMS Build and Upload [review]
echo Build command: npm run %BUILD_CMD%
echo API base URL: https://v1.saralive.net
...
del "%ZIP_FILE%"
echo.
echo Build and upload completed! [review] -^> %REMOTE_DIR%
echo CMS:  https://review.saralive.net/
echo API:  https://v1.saralive.net
pause
endlocal
