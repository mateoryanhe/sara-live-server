...
const en = {
  ...
  dailySocialIncome: 'Daily Social Turnover',
...
const es = {
  ...
  dailySocialIncome: 'Flujo social del día',
...
const pt = {
  ...
  dailySocialIncome: 'Volume social do dia',
...
const hi = {
  ...
  dailySocialIncome: 'दिन का सोशल टर्नओवर',
...
const id = {
  ...
  dailySocialIncome: 'Omzet sosial hari ini',
