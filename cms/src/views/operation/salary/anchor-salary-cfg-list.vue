  ...
  <div class="page-container">
    <el-card>
      ...
      <div class="content">
        ...
        <el-table v-loading="loading" :data="tableData" style="width: 100%">
          ...
          <el-table-column :label="t('pages.anchorSalaryCfgList.dailyEffectiveLiveCount')" prop="dailyEffectiveLiveCount" min-width="160"/>
          <el-table-column :label="t('pages.anchorSalaryCfgList.weeklyEffectiveLiveCount')" prop="weeklyEffectiveLiveCount" min-width="160"/>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="520px">
      <el-form ref="formRef" :model="currentRow" :rules="formRules" label-width="160px">
        <el-form-item :label="t('pages.anchorSalaryCfgList.dailyEffectiveLiveCount')" prop="dailyEffectiveLiveCount">
          <el-input-number v-model="currentRow.dailyEffectiveLiveCount" :min="0" controls-position="right"/>
        </el-form-item>
        <el-form-item :label="t('pages.anchorSalaryCfgList.weeklyEffectiveLiveCount')" prop="weeklyEffectiveLiveCount">
...
const formRules = computed<FormRules>(() => ({
  dailyEffectiveLiveCount: [
    {required: true, message: t('pages.anchorSalaryCfgList.dailyRequired'), trigger: 'change'},
  ],
  weeklyEffectiveLiveCount: [
    {required: true, message: t('pages.anchorSalaryCfgList.weeklyRequired'), trigger: 'change'},
  ],
  salaryAmount: [
