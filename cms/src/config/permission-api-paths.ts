...
const PERMISSION_API_PATHS: Record<string, string> = {
    ...
    'UserList:setCoinMerchantUserType': '/account/setUserType',
    ...
    CoinMerchantManagement: '/coinMerchant/coinMerchantList',
    'CoinMerchantManagement:view': '/coinMerchant/coinMerchantList',
    'CoinMerchantManagement:search': '/coinMerchant/coinMerchantList',
    'CoinMerchantManagement:create': '/coinMerchant/createCoinMerchant',
    'CoinMerchantManagement:resetPassword': '/coinMerchant/resetCoinMerchantPassword',
    'CoinMerchantManagement:cancel': '/coinMerchant/cancelCoinMerchant',
    ...
    'GuildTransferManagement:viewDetail': '/guildIncomeSettlementLog/cmsGuildIncomeSettlementLogDetail',
    'GuildTransferManagement:batchApprove': '/guildIncomeSettlementLog/cmsBatchApproveGuildSettlement',
    'GuildTransferManagement:reopenApproval': '/guildIncomeSettlementLog/cmsReopenGuildSettlementApproval',
    'GuildTransferManagement:copyPayout': '/guildIncomeSettlementLog/cmsCopyGuildSettlementPayout',
    'GuildTransferManagement:editReceivable': '/guildIncomeSettlementLog/cmsUpdateGuildSettlementReceivableUsd',
    'GuildTransferManagement:batchTransfer': '/guildIncomeSettlementLog/cmsBatchTransferGuildSettlement',
    'GuildTransferManagement:viewGuildDetail': '/guild/getGuildDetail',
    'GuildTransferManagement:transferInfo': '/guild/saveGuildTransferInfo',
    CoinMerchantGuildTransferManagement: '/guildIncomeSettlementLog/cmsGuildIncomeSettlementLogList',
    'CoinMerchantGuildTransferManagement:view': '/guildIncomeSettlementLog/cmsGuildIncomeSettlementLogList',
    'CoinMerchantGuildTransferManagement:search': '/guildIncomeSettlementLog/cmsGuildIncomeSettlementLogList',
    'CoinMerchantGuildTransferManagement:viewDetail': '/guildIncomeSettlementLog/cmsGuildIncomeSettlementLogDetail',
    'CoinMerchantGuildTransferManagement:batchApprove': '/guildIncomeSettlementLog/cmsBatchApproveGuildSettlement',
    'CoinMerchantGuildTransferManagement:reopenApproval': '/guildIncomeSettlementLog/cmsReopenGuildSettlementApproval',
    'CoinMerchantGuildTransferManagement:copyPayout': '/guildIncomeSettlementLog/cmsCopyGuildSettlementPayout',
    'CoinMerchantGuildTransferManagement:editReceivable': '/guildIncomeSettlementLog/cmsUpdateGuildSettlementReceivableUsd',
    ...
    PlatformAnchorVisibilityManagement: '/account/platformAnchorVisibilityByUserList',
    'PlatformAnchorVisibilityManagement:view': '/account/platformAnchorVisibilityByUserList',
    'PlatformAnchorVisibilityManagement:search': '/account/platformAnchorVisibilityByUserList',
    'PlatformAnchorVisibilityManagement:grant': '/account/batchGrantPlatformAnchorVisibility',
    'PlatformAnchorVisibilityManagement:revoke': '/account/batchRevokePlatformAnchorVisibility',
    'PlatformAnchorVisibilityManagement:listAnchors': '/account/platformAnchorListForVisibility',
    ...
    CoinMerchantRechargeCfgManagement: '/coinMerchantRechargeCfg/coinMerchantRechargeCfgList',
    'CoinMerchantRechargeCfgManagement:view': '/coinMerchantRechargeCfg/coinMerchantRechargeCfgList',
    'CoinMerchantRechargeCfgManagement:search': '/coinMerchantRechargeCfg/coinMerchantRechargeCfgList',
    'CoinMerchantRechargeCfgManagement:create': '/coinMerchantRechargeCfg/createCoinMerchantRechargeCfg',
    'CoinMerchantRechargeCfgManagement:edit': '/coinMerchantRechargeCfg/updateCoinMerchantRechargeCfg',
    'CoinMerchantRechargeCfgManagement:delete': '/coinMerchantRechargeCfg/deleteCoinMerchantRechargeCfg',
    ...
    'AnchorSalaryGameShareCfgManagement:create': '/anchorGameShareCfg/createAnchorGameShareCfg',
    'AnchorSalaryGameShareCfgManagement:edit': '/anchorGameShareCfg/updateAnchorGameShareCfg',
    'AnchorSalaryGameShareCfgManagement:delete': '/anchorGameShareCfg/deleteAnchorGameShareCfg',
    AnchorNoSalaryGameShareCfgManagement: '/anchorGameShareCfg/anchorGameShareCfgList',
    'AnchorNoSalaryGameShareCfgManagement:view': '/anchorGameShareCfg/anchorGameShareCfgList',
    'AnchorNoSalaryGameShareCfgManagement:create': '/anchorGameShareCfg/createAnchorGameShareCfg',
    'AnchorNoSalaryGameShareCfgManagement:edit': '/anchorGameShareCfg/updateAnchorGameShareCfg',
    'AnchorNoSalaryGameShareCfgManagement:delete': '/anchorGameShareCfg/deleteAnchorGameShareCfg',
